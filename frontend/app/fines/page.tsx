  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100 dark:bg-gray-950">
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8 w-full">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Fines & Compliance</h1>
          <p className="text-gray-500 dark:text-gray-400">Automated fine enforcement for the group</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border-l-4 border-blue-600">
            <p className="text-gray-500 dark:text-gray-400 text-sm">Total Fines</p>
        ...
        {showDispute && (
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm mb-6">
            <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4">Submit Dispute</h2>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm">
          <div className="p-6 border-b border-gray-100 dark:border-gray-800">
            <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">All Fines</h2>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  ...
                  <th className="text-left p-4 text-xs text-gray-500 dark:text-gray-400 font-semibold">REASON</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {fines.length === 0 ? (
                  ...
                  fines.map((fine) => (
                    <tr key={fine.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                      <td className="p-4 text-sm text-gray-600 dark:text-gray-300">{fine.memberId.slice(0, 8)}...</td>
                      ...
                      <td className="p-4">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          'bg-gray-100 dark:bg-gray-950 text-gray-700'
                        }`}>
                          {fine.status}
                        </span>
                      </td>
                      <td className="p-4">
                        ...
                        {fine.status === 'DISPUTED' && (
                          <span className="text-xs text-gray-400 dark:text-gray-500">Under review</span>
                        )}
                        {fine.status === 'WAIVED' && (
